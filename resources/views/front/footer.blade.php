            ...
            <div class="contacts">
                <div class="col-lg-4 col-md-12 col-sm-12 col-xs-12">
                    <div class="contacts-item">
                        ...
                        <div class="content">
                            <a href="tel:{{ $site_settings->contact_number }}" class="title">{{ $site_settings->contact_number }}</a>
                ...
                <div class="col-lg-4 col-md-12 col-sm-12 col-xs-12">
                    <div class="contacts-item">
                        ...
                        <div class="content">
                            <a href="mailto:{{ $site_settings->contact_email }}" class="title">{{ $site_settings->contact_email }}</a>
                ...
                <div class="col-lg-4 col-md-12 col-sm-12 col-xs-12">
                    <div class="contacts-item">
                        ...
                        <div class="content">
                            <a href="#" class="title">{{ $site_settings->address }}</a>
    ...
    <div class="container">
        <div class="row">
            <div class="form_search-wrap">
                <form id="search_form" name="search_form" method="get" action="{{ route('query') }}">
